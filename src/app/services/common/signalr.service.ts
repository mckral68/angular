...
export class SignalRService {
  ...
  start(hubUrl: string) {
    ...
    hubConnection.onreconnected(connectionId => console.log("Yeniden Bağlandı"));
    hubConnection.onreconnecting(error => console.log("Yeniden Bağlanıyor"));
    hubConnection.onclose(error => console.log("Bağlantı Kapandı"));
